...
EN: dict[str, str] = {
    ...
    "widget.cache_hit_line": "cache hit {cache_read} tok · {elapsed_s:.1f}s elapsed",
    "widget.cache_idle_line": "cache — · {elapsed_s:.1f}s elapsed",
...
ZH: dict[str, str] = {
    ...
    "widget.cache_hit_line": "缓存命中 {cache_read} tok · {elapsed_s:.1f}s 用时",
    "widget.cache_idle_line": "缓存 — · {elapsed_s:.1f}s 用时",
