...
@pytest.mark.asyncio
async def test_read_scope_subagent_returns_result(tmp_path, scripted_model_factory):
...
@pytest.mark.asyncio
async def test_subagent_failure_is_captured_not_raised(tmp_path, failing_model_factory):
